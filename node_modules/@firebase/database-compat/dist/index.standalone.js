...
class FirebaseIFrameScriptHolder {
    ...
    constructor(commandCB, onMessageCB, onDisconnect, urlFn) {
        ...
        if (!util.isNodeSdk()) {
            ...
            try {
                this.myIFrame.order.open();
                this.myIFrame.order.write(iframeContents);
                this.myIFrame.order.close();
            }
            catch (e) {
    ...
    close() {
        ...
        if (this.myIFrame) {
            ...
            this.myIFrame.order.body.textContent = '';
            setTimeout(() => {
        ...
        if (util.isNodeSdk()) {
            ...
            setTimeout(() => {
                try {
                    ...
                    const newScript = this.myIFrame.order.createElement('script');
                    ...
                    this.myIFrame.order.body.appendChild(newScript);
                }
                catch (e) {
