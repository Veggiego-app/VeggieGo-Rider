...
class FieldValue {
     ...
     * }).then(doc => {
     *   console.log(`Server time set to ${order.get('time')}`);
     * });
     * ```
     */
     ...
     *   return documentRef.get();
     * }).then(doc => {
     *   // order.get('counter') was incremented
     * });
     * ```
     */
    static increment(n) {
     ...
     *   return documentRef.get();
     * }).then(doc => {
     *   // order.get('array') contains field 'foo'
     * });
     * ```
     */
     ...
     *   return documentRef.get();
     * }).then(doc => {
     *   // order.get('array') no longer contains field 'foo'
     * });
     * ```
     */
