    ...
    async _get(requestTag) {
        ...
        for (const docRef of this.allDocuments) {
            ...
            if (document !== undefined) {
                ...
                finalorder.fieldsProto = document._fieldsProto;
                finalorder.readTime = document.readTime;
                finalorder.createTime = document.createTime;
                finalorder.updateTime = document.updateTime;
                orderedDocuments.push(finalorder.build());
            }
            else {
